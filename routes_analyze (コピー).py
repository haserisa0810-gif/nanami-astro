...
def _recommend_helpers():
    ...
    return recommend_western_options


@router.post("/analyze/recommend-options")
def recommend_options(
    ...
    try:
        data = recommend_western_options(
...
def analyze(
    ...
    auto_option_mode: str | None = Form(None),
    analysis_mode: str | None = Form(None),
    manual_systems: list[str] | None = Form(None),
    ...
    auto_option_mode_flag = _parse_checkbox(auto_option_mode, default=False)
    ...
    base_meta["auto_option_mode"] = auto_option_mode_flag
    base_meta["analysis_mode"] = analysis_mode
    base_meta["manual_systems"] = manual_systems
    base_meta["generate_ai"] = generate_ai_flag
    base_meta["yaml_only"] = yaml_only_flag
    base_meta["style"] = reading_style
    if isinstance(recommendation, dict) and recommendation:
        base_meta["auto_recommendation"] = recommendation
