...
【主役を決めてから書く（最優先）】
- 書き始める前に、この鑑定書の主役を最大2つ特定する
- 主役の選定は、同一ハウスの天体集中（3天体以上）、アングル（1・4・7・10ハウス）上の天体、太陽・月・ASC、オーブの小さいタイトなアスペクトの順で優先する
- 主役は最大2つ。3つ以上を同列に並べない
- 各章は主役の軸から構成し、主役と無関係な配置は均等に並べず軽く触れるに留める
