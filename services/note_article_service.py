...
12星座別運勢では出生図データを使わないため、主役は「その月、その星座に効くトランジット」としてください。
外惑星（木星・土星・天王星・海王星・冥王星）のアスペクトを主役候補とし、最も影響の大きいもの1つを軸にしてください。
内惑星（月・水星・金星）の動きは前振り・例外として従属させてください。
日付を均等に並べず、主役トランジットの日を軸に、他の日付は前振り・余波・例外として配置してください。"""
